...
var Kabukibot = function(twitchClient, database, chanMngr, userMngr, pluginMngr, acl, log, dispatcher, config) {
...
Kabukibot.prototype = {
	...
	setup: function() {
		...
		this.pluginMngr.setup(this, this.dispatcher);

		return this;
	},

	run: function() {
		var twitch = this.twitchClient, log = this.log;
...
module.exports.getBot = function(config, logLevel) {
	...
	return new Kabukibot(twitchClient, db, chanMngr, userMngr, pluginMngr, acl, log, dispatcher, config);
};
