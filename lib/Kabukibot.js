...
var Kabukibot = function(twitchClient, database, chanMngr, userMngr, acl, log, dispatcher, config) {
...
module.exports.getBot = function(config, logLevel) {
	...
	return new Kabukibot(twitchClient, db, chanMngr, userMngr, acl, log, dispatcher, config);
};
