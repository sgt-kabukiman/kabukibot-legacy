...
EventDispatcher.prototype = {
	...
	removeMessageListener: function(channel, callback) {
		return this.removeListener('message', channel, callback);
	},

	removeTextListener: function(channel, callback) {
		return this.removeListener('text', channel, callback);
	},

	removeCommandListener: function(channel, callback) {
		return this.removeListener('command', channel, callback);
	},
