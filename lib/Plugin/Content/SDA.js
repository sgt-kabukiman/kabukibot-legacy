...
SDAContentPlugin.prototype = {
	...
	onCommand: function(command, args, message) {
		...
		switch (command) {
			case 'agdq':
				message.respondToAll('AGDQ stands for Awesome Games Done Quick, an annual charity speedrunning marathon held in the US. It traditionally collects money for the Prevent Cancer Foundation.');
				return;

			case 'sgdq':
				message.respondToAll('SGDQ stands for Summer Games Done Quick, the summer version of AGDQ. It\'s an annual charity speedrunning marathon.');
				return;

			case 'sgdq2014':
				message.respondToAll('SGDQ 2014 is from June 22 to June 28 in Denver.');
				return;
		}
	}
};
