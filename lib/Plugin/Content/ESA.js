...
function ESAContentPlugin() {
	...
	this.dictEntries = {
		...
		esa2014_info: 'ESA 2014 is at Nyeport in Skövde (Sweden), from July 27th ({{#reldate}}27 Jul 2014{{/reldate}}) to August 3rd (main marathon); clean up and bonus stream will go on until August 6th.'
	};
}
