...
TextMessage.prototype = {
	...
	respond: function(text, recipient) {
		return this.channel.say(recipient === false ? text : (this.getUsername() + ', ' + text));
	},

	respondToAll: function(text) {
		return this.respond(text, false);
	}
};
