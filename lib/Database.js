...
Database.prototype = {
	connect: function(callback) {
		var db = new sqlite3.Database(this.file, sqlite3.OPEN_READWRITE | sqlite3.OPEN_CREATE, function() {
			db.serialize(function() {
				db.run('CREATE TABLE IF NOT EXISTS channel (name VARCHAR(200))');
	...
	insert: function(table, data, callback) {
		var query, cols, placeholder, placeholders, params, col;
	...
	del: function(table, where, callback) {
		var query, placeholder, conditions, params, col;
